...
/**
 * Lets the player swap which equipped backpack (chest slot or Curios back slot) sits on a shelf.
 *
 * Author: MrCrayfish
 */
public class BackpackShelfMenu extends CustomContainerMenu
{
    ...
    public BackpackShelfMenu(int windowId, Inventory playerInventory, Container managementContainer, Container shelfContainer, UnlockableSlots managementSlots)
    {
        ...
        UnlockableController controller = new ManagementUnlockableController(managementSlots, List.of(playerInventory));
