...
public class ClientPlayHandler
{
    ...
    public static void handleSyncAugmentChange(MessageSyncAugmentChange message)
    {
        ...
        {
            screen.updateAugment(message.position(), message.augment(), message.state());
        }
    }
    ...
    public static void handleMessageShowEquipHint(MessageShowEquipHint message, MessageContext context)
    {
        ...
        minecraft.player.displayClientMessage(Component.translatable("wanderersbackpack.gui.after_equipped_message",
            Component.translatable("wanderersbackpack.gui.wanderersbackpack_equipped").withStyle(ChatFormatting.GOLD),
