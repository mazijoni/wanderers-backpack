...
public record MessageSetAugmentState(Position position, boolean state)
{
    public static final StreamCodec<RegistryFriendlyByteBuf, MessageSetAugmentState> STREAM_CODEC = StreamCodec.composite(
        Position.STREAM_CODEC, MessageSetAugmentState::position, ByteBufCodecs.BOOL, MessageSetAugmentState::state, MessageSetAugmentState::new
    );
