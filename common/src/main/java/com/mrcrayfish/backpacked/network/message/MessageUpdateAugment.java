...
public record MessageUpdateAugment(Position position, Augment<?> augment)
{
    public static final StreamCodec<RegistryFriendlyByteBuf, MessageUpdateAugment> STREAM_CODEC = StreamCodec.composite(
        Position.STREAM_CODEC, MessageUpdateAugment::position, Augment.STREAM_CODEC, MessageUpdateAugment::augment, MessageUpdateAugment::new
    );
