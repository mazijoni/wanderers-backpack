...
public class TextInputMenu extends PopupMenu
{
    ...
    public TextInputMenu(PopupMenuHandler handler, String initialInput, int maxLength, Consumer<String> onSave)
    {
        ...
        TitleWidget title = new TitleWidget(Component.translatable("wanderersbackpack.gui.rename"), Minecraft.getInstance().font);
        ...
        this.layout.addChild(BackpackButtons.builder()
            .setSize(WIDTH / 3, 18)
            .setLabel(Component.translatable("wanderersbackpack.button.save"))
            .setAction(btn -> {
