...
public class LightweaverMenu extends AugmentSettingsMenu
{
    ...
    private static final Component LIGHT_LEVEL_LABEL = Component.translatable("augment.wanderersbackpack.lightweaver.light_level");
    private static final Component PLACE_SOUND_LABEL = Component.translatable("augment.wanderersbackpack.lightweaver.place_sound");
    private static final Component LIGHT_LEVEL_TOOLTIP = Component.translatable("augment.wanderersbackpack.lightweaver.light_level.tooltip");
    private static final Component PLACE_SOUND_TOOLTIP = Component.translatable("augment.wanderersbackpack.lightweaver.place_sound.tooltip");
        ...
        super(handler, menu -> {
            ...
            layout.addChild(createOption(
                ...
                Stepper.builder()
                    ...
                    .setRange(0, 15)
                    .setWrap(true)
                    .setOnChange(newValue -> holder.update(holder.get().setMinimumLight(newValue)))
                    .build(),
                divider.getWidth()
            ));
            layout.addChild(createOption(
                PLACE_SOUND_LABEL,
                PLACE_SOUND_TOOLTIP,
                BackpackButtons.onOff(() -> holder.get().sound(), newValue -> holder.update(holder.get().setSound(newValue))).setSize(60, 18).build(),
                divider.getWidth()
            ));
            return layout;
        });
