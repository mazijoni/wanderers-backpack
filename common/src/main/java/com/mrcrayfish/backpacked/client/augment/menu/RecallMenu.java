...
/**
 * Settings popup for the Recall augment - lets the player bind their backpack to whatever shelf
 * they're currently looking at.
 */
public class RecallMenu extends AugmentSettingsMenu
{
    private static final Component OPTIONS_LABEL = Component.translatable("wanderersbackpack.gui.options");
    private static final Component SET_SHELF_LABEL = Component.translatable("augment.wanderersbackpack.recall.link_shelf");
    private static final Component SET_SHELF_TOOLTIP = Component.translatable("augment.wanderersbackpack.recall.link_shelf.tooltip");
    private static final Component CHECKING_STATUS_LABEL = Component.translatable("augment.wanderersbackpack.recall.status.checking");
    private static final Component NOT_SET_LABEL = Component.translatable("augment.wanderersbackpack.recall.status.no_shelf_linked");
    private static final Component NO_SHELF_LABEL = Component.translatable("augment.wanderersbackpack.recall.status.shelf_missing");
