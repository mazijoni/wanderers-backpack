...
public class Config
{
    ...
    public static class Backpack
    {
        ...
        public static class Cosmetics
        {
            ...
            public final StringProperty defaultCosmetic = StringProperty.create("wanderersbackpack:vintage", new ResourceLocationValidator("Value needs to be a match an existing backpack"));
            ...
            public final BoolProperty disableCustomisation = BoolProperty.create(true);
            ...
            @ConfigProperty(name = "disabledCosmetics", comment = """
                ...
                your clipboard.
                Example: disabledCosmetics = ["wanderersbackpack:rocket", "wanderersbackpack:classic", "wanderersbackpack:honey_jar"]""")
        ...
        public static class Inventory
        {
            ...
            public static class Slots
            {
                @ConfigProperty(name = "unlockAllSlots", comment = """
                        ...
                        into the world if the slot they are in is now locked. You have been warned.""")
                public final BoolProperty unlockAllSlots = BoolProperty.create(true);
    ...
    public static class Augments
    {
        @ConfigProperty(name = "disabledAugments", comment = """
                ...
                of augments.
                Example: disabledAugments = ["wanderersbackpack:recall", "wanderersbackpack:lootbound"]""")
