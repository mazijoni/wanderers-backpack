...
public class ModAugmentTypes
{
    ...
    public static final RegistryEntry<AugmentType<BedAugment>> BED = RegistryEntry.custom(ModRegistries.AUGMENT_TYPES, Utils.rl("bed"), () -> BedAugment.TYPE);
    public static final RegistryEntry<AugmentType<FluidTankAugment>> FLUID_TANK = RegistryEntry.custom(ModRegistries.AUGMENT_TYPES, Utils.rl("fluid_tank"), () -> FluidTankAugment.TYPE);
}
