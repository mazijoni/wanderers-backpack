        ...
        ModList.get().getModContainerById(Constants.MOD_ID).ifPresent(container ->
        {
            ...
            else if(minecraft.player != null)
            {
                ...
                modName.setStyle(modName.getStyle()
                        ...
                        .withUnderlined(true)
                        .withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.translatable("wanderersbackpack.chat.open_curseforge_page")))
                        .withClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, "https://www.curseforge.com/minecraft/mc-mods/configured")));
                Component message = Component.translatable("wanderersbackpack.chat.install_configured", modName);
